 ...
 \centering
    ...
    %\subfloat{% Subtable 1
       \resizebox{0.99\textwidth}{!}{% <------ Don't forget this %
        ...
        \hline
        \multicolumn{8}{|c|}{Hospital}                                               \\ \hline
    ...
    %\subfloat{% Subtable 2
        \resizebox{\textwidth}{!}{% <------ Don't forget this %
            \raisebox{2\baselineskip}{%
                \begin{tabular}{!{\color{pharmacolor}\vline}l !{\color{pharmacolor}}l!{\color{pharmacolor}\vline}l!{\color{pharmacolor}\vline}l!{\color{pharmacolor}\vline}}\arrayrulecolor{pharmacolor}
                \hline
                \multicolumn{4}{|c|}{Pharmaceutical company}                                               \\ \hline
                &{HospitalCaseID} & {Timestamp} & Activity \\ \hline
                $\Evt_{21}$&312          & {2022-07-15T09:06}           & DOR \\ \hline
                $\Evt_{22}$&711         & {2022-07-15T09:30}           & DOR \\ \hline
                $\Evt_{23}$&312         & {2022-07-15T11:06}           & PDL \\ \hline
                $\Evt_{24}$&711         & {2022-07-15T11:30}           & PDL \\ \hline
                $\Evt_{25}$&312         & {2022-07-15T13:06}           & SD  \\ \hline
                $\Evt_{26}$&711          & {2022-07-15T13:30}           & SD  \\ \hline
                \end{tabular}%
            }% raisebox
        }% resize box
     %\end{minipage}%<
     ...
     %\begin{minipage}[t]{0.49\linewidth}
        \resizebox{\textwidth}{!}{% <------ Don't forget this %
            \raisebox{2.5\baselineskip}{%
                \begin{tabular}{!{\color{specializedcliniccolor}\vline}l!{\color{specializedcliniccolor}}l!{\color{specializedcliniccolor}\vline}l!{\color{specializedcliniccolor}\vline}l!{\color{specializedcliniccolor}\vline}}\arrayrulecolor{specializedcliniccolor}
                \hline
                \multicolumn{4}{!{\color{teal}\vline}c!{\color{teal}\vline}}{Specialized clinic}                                               \\ \hline
                & {TreatmentID}  & {Timestamp} & Activity \\ \hline
