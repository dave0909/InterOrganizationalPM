...
Our protocol involves two main actors: a \Compo{Secure Miner} (henceforth, \SecM) and one to many \Compo{Log Provisioner}s ($\LPrv_1, \ldots, \LPrv_n \in \LPrvS$). Their behaviour is documented in \cref{alg:secm} and \cref{alg:lprv}
