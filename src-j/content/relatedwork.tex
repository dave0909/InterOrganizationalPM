...
TEEs, were initially proposed by Rushby~\citet{rushby1981design}, enabling multiple systems with different security requirements to coexist on a single platform. Owing to kernel separation, the system is divided into numerous segments, ensuring robust isolation between them.
