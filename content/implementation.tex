...
\texttt{Trusted Execution Environment}s are the core technologies of our solution. Application and data located in the Trusted Execution Environment are protected through hardware-encryption tecniques in a reserved zone of the \texttt{Organization Machine}'s CPU.  
